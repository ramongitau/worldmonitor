...
import type { CiiScore, StrategicRisk, TrendDirection, SeverityLevel } from '../../../../src/generated/server/worldmonitor/intelligence/v1/service_server';
...
export async function fetchACLEDProtests(): Promise<AcledEvent[]> {
...
export function computeCIIScores(protests: AcledEvent[]): CiiScore[] {
